...
export const newTelephonicConsultation: modelTypes.TelephonicConsultationCreateVM = {
  patientId: 0,
  encounterId: 0,
  practitionerId: 0,
  dateOfCall: new Date(),
...
export const newTelephonicConsultationUpdate: modelTypes.TelephonicConsultationUpdateVM = {
  id: 0,
  practitionerId: 0,
  dateOfCall: new Date(),
  consultationContent: '',
