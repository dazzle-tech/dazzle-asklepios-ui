...
export const EnvironmentalFactors = ({ formData, setFormData }: EnvironmentalFactorsProps) => {
      ...
      <CardContent className="!px-6 !pt-5 !pb-6 !space-y-6">
        <section className="!grid md:!grid-cols-3 !gap-6">
          <div className="!space-y-2.5">
            ...
            >
              <SelectTrigger
                className="!text-[14px] !bg-[var(--input-bg)] !text-[var(--foreground)] !border "
                style={inputBox}
              >
        ...
        <section className="!space-y-2.5">
          ...
          <Textarea
            ...
            onChange={e => setFormData({ ...formData, systemFactors: e.target.value })}
            className={`${
              mode === 'light'
                ? '!min-h-[96px] !text-[14px] !border !border-[#rgb(212 212 212)] !rounded-[8px]'
                : '!min-h-[96px] !text-[14px] !border !border-[#3a3a3a] !rounded-[8px]'
