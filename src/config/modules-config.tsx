...
export const MedicalSheets: MedicalSheet[] = [
  ...
  },
  {
    ...
    code: 'VTE_RISK_ASSESSMENT',
    icon: <FontAwesomeIcon icon={faBraille} className="icon" />,
    path: '/vte-risk-assessment'
  },
  {
    name: 'Pressure Ulcer Risk Assessment',
    code: 'BRADEN_SCALE_FOR_PRESSURE_ULCER',
    icon: <FontAwesomeIcon icon={faBed} className="icon" />,
    path: '/pressure-ulce-risk-assessment'
  },
  {
    name: 'Glasgow Coma Scale',
    code: 'GLASGOW_COMA_SCALE',
  ...
  },
  {
    ...
    code: 'REFERRAL_REQUEST',
    icon: <FontAwesomeIcon icon={faUserDoctor} className="icon" />,
    path: '/referral-request'
  },
  {
    name: 'Multidisciplinary Team Notes',
    code: 'MULTIDISCIPLINARY_TEAM_NOTES',
  ...
  {
    name: 'Bedside Procedures',
    code: 'BEDSIDE_PROCEDURES_REQUEST',
  ...
  {
    name: 'Optometric Exam',
    code: 'OPTOMETRIC_EXAM',
    icon: <FontAwesomeIcon icon={faEye} className="icon" />,
    path: '/optometric-exam',
    type: 'Specialty'
  },
  {
    name: 'Audiometry Puretone',
    code: 'AUDIOMETRY_PURETONE',
  ...
  },
  {
    ...
    code: 'IV_FLUID_ADMINISTRATION',
    icon: <FontAwesomeIcon icon={faSyringe} className="icon" />,
    path: '/iv-fluid-administration'
  },
  {
    name: 'Continuous Observation',
    code: 'CONTINUOUS_OBSERVATIONS',
    icon: <FontAwesomeIcon icon={faSyringe} className="icon" />,
    path: '/continuous-observation'
  },
  {
    name: 'FLACC Neonates Pain Assessment',
    code: 'FLACC_NEONATES_PAIN_ASSESSMENT',
    icon: <FontAwesomeIcon icon={faSyringe} className="icon" />,
  ...
  },
  {
    ...
    code: 'PREVIOUS_MEASUREMENTS',
    icon: <FontAwesomeIcon icon={faRuler} className="icon" />,
    path: '/previous-measurements'
  },
  {
    name: 'Attachments',
    code: 'ATTACHMENTS',
  ...
  },
  {
    ...
    icon: <FontAwesomeIcon icon={faHeartbeat} className="icon" />,
    path: '/physical-examination'
  },
  {
    name: 'Pain Assessment',
    code: 'PAIN_ASSESSMENT',
    icon: <FontAwesomeIcon icon={faThermometerHalf} className="icon" />,
    path: '/pain-assessment'
  },
  {
    name: 'General Assessment',
    code: 'GENERAL_ASSESSMENT',
    icon: <FontAwesomeIcon icon={faClipboardCheck} className="icon" />,
    path: '/general-assessment'
  },
  {
    name: 'Functional Assessment',
    code: 'FUNCTIONAL_ASSESSMENT',
    icon: <FontAwesomeIcon icon={faWalking} className="icon" />,
    path: '/functional-assessment'
  },
  {
    name: 'Repositioning',
    code: 'REPOSITIONING',
    icon: <FontAwesomeIcon icon={faRedoAlt} className="icon" />,
    path: '/repositioning'
  },
  {
  ...
  },
  {
    ...
    code: 'WOUND_CARE_DOCUMENTATION',
    icon: <FontAwesomeIcon icon={faBandAid} className="icon" />,
    path: '/wound-care-documentation'
  },
  {
    name: 'Physician Order Summary',
    code: 'PHYSICIAN_ORDER_SUMMARY',
    icon: <FontAwesomeIcon icon={faFileMedical} className="icon" />,
    path: '/physician-order-summary'
  },
  {
    name: 'Pediatric',
    code: 'PEDIATRIC',
    icon: <FontAwesomeIcon icon={faChild} className="icon" />,
    path: '/pediatric',
    type: 'Specialty'
  },
  {
    name: 'Service And Product',
    code: 'SERVICEANDPRODUCTS',
    icon: <FontAwesomeIcon icon={faBoxOpen} className="icon" />,
...
export const MODULES: Module[] = [
  {
    ...
    screens: [
      ...
      },
      {
        ...
        icon: 'FaInstalod',
        viewOrder: 15,
        navPath: 'potintial-duplicate'
      },
      {
        name: 'Brand Medications',
        code: 'BRAND_MEDICATIONS',
        description: '',
        icon: 'FaBottleDroplet',
        viewOrder: 8,
        navPath: 'brand-medications'
      },
      {
        name: 'Lists Of Value',
        code: 'LISTS_OF_VALUE',
      ...
      },
      {
        ...
        code: 'MODULES_AND_SCREENS',
        description: '',
        icon: 'FaDesktop',
        viewOrder: 0,
        navPath: 'modules-setup'
      },
      {
        name: 'Data Validation Manager',
        code: 'DATA_VALIDATION_MANAGER',
        description: '',
        icon: 'FaDatabase',
        viewOrder: 1,
        navPath: 'dvm'
      ...
      },
      {
        ...
        code: 'PRESCRIPTION_INSTRUCTIONS',
        description: '',
        icon: 'FaPrescriptionBottle',
        viewOrder: 15,
        navPath: 'prescription-instructions'
      },
      {
        name: 'Age Group',
        code: 'AGE_GROUP',
        description: 'Age Group Setup',
        icon: 'FaBaby',
        viewOrder: 10,
        navPath: 'age-group'
      },
      ...
      },
      {
        name: 'Catalog Setup',
        code: 'CATALOG_SETUP',
        description: 'Diagnostic tests catalog',
        icon: 'FaBook',
        viewOrder: 14,
        navPath: 'catalog'
      },
      {
        ...
        code: 'DIAGNOSTICS_SETUP',
        description: 'Define Diagnostic tests (Lab, Rad, Path)',
        icon: 'FaMicroscope',
        viewOrder: 13,
        navPath: 'diagnostics-test'
      },
      {
        name: 'Diagnostics Setup Old',
        code: 'DIAGNOSTICS_SETUP_OLD',
        description: 'Define Diagnostic tests (Lab, Rad, Path)',
        icon: 'FaMicroscope',
        viewOrder: 13,
        navPath: 'diagnostics-test-old'
      },
      {
        name: 'Vaccine Setup',
        code: 'VACCINE_SETUP',
        ...
        icon: 'FaSyringe',
        viewOrder: 9,
        navPath: 'vaccine-setup'
      },
      {
        name: 'Procedure Setup',
        code: 'PROCEDURE_SETUP',
        description: '',
        icon: 'FaProductHunt',
        viewOrder: 10,
        navPath: 'procedure-setup'
      },
      {
        name: 'Room Bed Setup',
        code: 'ROOM_BED_SETUP',
      ...
      {
        name: 'Medication Matrix Setup',
        code: 'MEDICATION_MATRIX_SETUP',
        description: '',
        icon: 'FaMendeley',
        viewOrder: 12,
        navPath: 'med-matrix-setup'
      },
      {
        name: 'Services Setup',
        code: 'SERVICES_SETUP',
        ...
        viewOrder: 11,
        navPath: 'services-setup'
      },
      {
        name: 'Vaccine Schedule Setup',
        code: 'VACCINE_SCHEDULE_SETUP',
        description: 'define vaccine age time',
        icon: 'FaSyringe',
        viewOrder: 8,
        navPath: 'vaccines-schedule-setup'
      },
      {
        name: 'Checklists',
        code: 'CHECKLISTS',
        description: 'Cheklist',
        icon: 'FaAdn',
        viewOrder: 5,
        navPath: 'checklists'
      },
      {
        ...
        code: 'OPERATION_SETUP',
        description: 'Major Operations',
        icon: 'FaHeadSideMask',
        viewOrder: 10,
        navPath: 'operation-setup'
      },
      {
        ...
        icon: 'FaBoxOpen',
        viewOrder: 10,
        navPath: 'purchase-approvals-setup'
      },
      {
        name: 'Questionnaire Setup',
        code: 'QUESTIONNAIRE_SETUP',
        description: '',
        icon: 'FaClipboardQuestion',
        viewOrder: 5,
        navPath: 'questionnaire-setup'
      },
      {
        name: 'Medication Schedule Setup',
        code: 'MEDICATION_SCHEDULE_SETUP',
        description: '',
        icon: 'FaPlay',
        viewOrder: 9,
        navPath: 'medication-schedule'
      },
      {
        name: 'Visit Duration',
        code: 'VISIT_DURATION',
      ...
      },
      {
        ...
        icon: 'FaClock',
        viewOrder: 20,
        navPath: 'language-setup'
      },
      {
        name: 'Clinical Protocols Setup',
        code: 'CLINICAL_PROTOCOLS_SETUP',
        description: 'where to define clinical protocols dynamically',
        icon: 'FaStethoscope',
        viewOrder: 1,
        navPath: 'clincal-protocol-setup'
      },
      {
        name: 'Shift Setup',
        code: 'SHIFT_SETUP',
      ...
      },
      {
        name: 'Supplier Setup',
        code: 'SUPPLIER_SETUP',
        description: 'Supplier Setup',
        icon: 'FaRedRiver',
        viewOrder: 15,
        navPath: 'supplier-setup'
      },
      {
        name: 'Surgical Kits Setup',
        code: 'SURGICAL_KITS_SETUP',
        description: '',
        icon: 'FaCheckToSlot',
        viewOrder: 10,
        navPath: 'surgical-kits-setup'
      },
      {
        name: 'User New',
        code: 'USER',
      ...
      {
        name: 'Test Report Template Setup',
        code: 'TEST_REPORT_TEMPLATE_SETUP',
        description: 'to link test radiology or pathology to specific template',
        icon: 'FaList',
        viewOrder: 0,
        navPath: 'report-result-template'
      },
      {
        name: 'Country Setup',
        code: 'COUNTRY_SETUP',
  ...
  },
  {
    ...
    screens: [
      ...
      },
      {
        name: 'CDT CODES',
        code: 'CDT_CODES',
        description: 'International dental procedures codes',
        icon: 'FaTooth',
        viewOrder: 1,
        navPath: 'cdt-setup'
      },
    ...
    screens: [
      {
        ...
        icon: 'FaFilePen',
        viewOrder: 1,
        navPath: 'patient-profile'
      },
      {
        name: 'Information Desk',
        code: 'INFORMATION_DESK',
        description: 'Search and view registered patients in specific facility',
        icon: 'FaPersonRays',
        viewOrder: 0,
        navPath: 'information-desk'
      },
      {
        name: 'Files Merge',
        code: 'FILES_MERGE',
    ...
    screens: [
      {
        ...
        icon: 'FaVideo',
        viewOrder: 0,
        navPath: 'tele-consultation-screen'
      }
    ]
  },
  {
    ...
    screens: [
      {
        ...
        icon: 'FaBedPulse',
        viewOrder: 1,
        navPath: 'inpatient-encounters-list'
      },
      {
        name: 'Waiting List',
        code: 'WAITING_LIST',
        ...
        icon: 'FaClock',
        viewOrder: 0,
        navPath: 'waiting-encounters-list'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    screens: [
      ...
      },
      {
        ...
        icon: 'FaClover',
        viewOrder: 2,
        navPath: 'recovery-module'
      },
      {
        name: 'Operation Room Materials',
        code: 'OPERATION_ROOM_MATERIALS',
        description: '',
        icon: 'FaSyringe',
        viewOrder: 0,
        navPath: 'operation-room-materials'
      }
    ]
  },
  {
    ...
    screens: [
      {
        ...
        icon: 'FaPills',
        viewOrder: 0,
        navPath: 'pharmacy-internal-orders'
      },
      {
        name: 'ePrescriptions',
        code: 'EPRESCRIPTIONS',
        ...
        icon: 'FaPrescription',
        viewOrder: 1,
        navPath: 'pharmacy-ePrescriptions'
      },
      {
        name: 'Controlled Medications',
        code: 'CONTROLLED_MEDICATIONS',
        description: '',
        icon: 'FaBiohazard',
        viewOrder: 2,
        navPath: 'pharmacy-controlled-medications'
      }
    ]
  },
  {
    ...
    screens: [
      ...
      },
      {
        name: 'Products Setup',
        code: 'PRODUCTS_SETUP',
        description: 'setup for products that will be used in warehouse transactions',
        icon: 'FaSitemap',
        viewOrder: 11,
        navPath: 'inventory-management-product-setup'
      }
    ]
  },
  {
    ...
    screens: [
      ...
      },
      {
        ...
        icon: 'FaSitemap',
        viewOrder: 11,
        navPath: 'inventory-product-setup'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    screens: [
      ...
      {
        name: 'List of Requisition',
        code: 'LIST_OF_REQUISITION',
        description: '',
        icon: 'FaMoneyBills',
        viewOrder: 5,
        navPath: 'list-of-requisition'
      },
      {
      ...
      },
      {
        ...
        viewOrder: 0,
        navPath: 'purchasing-requisition'
      },
      {
        name: 'Requisition Approval',
        code: 'REQUISITION_APPROVAL',
        description: '',
        icon: 'FaRegThumbsUp',
        viewOrder: 1,
        navPath: ''
