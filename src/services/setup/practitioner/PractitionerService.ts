...
export const PractitionerService = createApi({
  ...
  endpoints: builder => ({
    ...
    getPractitionersByFacility: builder.query<PagedResult<any>, { facilityId: number | string } & PagedParams>({
    ...
    getPractitionersBySpecialty: builder.query<PagedResult<any>, { specialty: string } & PagedParams>({
