...
export const PolicyAssignmentService = createApi({
    ...
    endpoints: (builder) => ({
        ...
        getEffectiveActivePolicyAssignments: builder.query<
            PolicyAssignment[],
            {
                facilityId: number;
                departmentId: number;
        ...
        >({
            query: ({ facilityId, departmentId, resourceType, resourceId }) => ({
                url: '/api/setup/policy-assignments/active/effective',
                method: 'GET',
                params: {
                    facilityId,
                    departmentId,
...
export const {
    ...
    useLazyGetEffectiveActivePolicyAssignmentsQuery
