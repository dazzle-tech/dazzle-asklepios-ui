...
export const inventoryProductsService = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getInventoryProductsByName: builder.query<
      PagedResult<InventoryProduct>,
    ...
    getInventoryProductByType: builder.query<
      PagedResult<InventoryProduct>,
    ...
    getInventoryProductByInventoryType: builder.query<
      PagedResult<InventoryProduct>,
    ...
    getInventoryProductByBaseUom: builder.query<
      PagedResult<InventoryProduct>,
    ...
    getInventoryProductById: builder.query<InventoryProduct, { id: number | string }>({
      ...
      providesTags: (result, error, id) => [
        { type: 'InventoryProducts', id: id as unknown as Id },
      ],
    }),
    ...
    toggleInventoryProductActive: builder.mutation<
      InventoryProduct,
      { id: number | string }
    >({
      query: ({ id }) => ({
    ...
    searchInventoryProducts: builder.query<
      PagedResult<InventoryProduct>,
