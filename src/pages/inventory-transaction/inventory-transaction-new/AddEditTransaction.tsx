...
import { useUploadAttachmentsMutation, useGetInventoryTransactionAttachmentsQuery, useDeleteAttachmentMutation, useGetDownloadUrlMutation } from '@/services/inventory/inventory-transaction/attachmentService';
...
const AddEditTransaction = ({ open, setOpen, transaction, setTransaction, refetch, refetchAttachmentList }) => {
    ...
    const { data: existingAttachments, refetch: refetchAttachments } = useGetInventoryTransactionAttachmentsQuery(
    ...
    const leftContent = () => {
        ...
        return (
            <>
                ...
                {transaction?.key && existingAttachments && existingAttachments.data && existingAttachments.data.length > 0 && (
