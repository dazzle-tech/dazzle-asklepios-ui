    ...
    const columns: ColumnConfig[] = [
        {
         ...
         render: (rowData, index) => (
                <Input
                    ...
                    onChange={(val: string) => handleRowChange(index, 'quantity', val)}
                    style={{ width: '100%' }}
                     disabled={rowData?.statusLkey == '1804482322306061'}
                />
            ),
    ...
    return (
        <Form fluid>
            ...
            <div className="table-buttons-right">
                ...
                <MyButton appearance="primary" onClick={handleAddProductRow} >
                    Add Product
                </MyButton>
                <MyButton appearance="primary" onClick={handleSaveAllProducts} >
                    Save All product
                </MyButton>
...
export default AddEditTransferProduct;
