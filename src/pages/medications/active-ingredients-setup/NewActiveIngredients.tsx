...
import { Accordion, ButtonToolbar, IconButton } from 'rsuite';
import { Block, Check, PlusRound, ArrowDown, ArrowUp } from '@rsuite/icons';
  ...
  return (
    ...
    >
      <ButtonToolbar>
        ...
        <Divider vertical />
        <IconButton appearance="primary" color="cyan" icon={<PlusRound />}>
            ...
            <Form layout="inline" fluid>
              ...
              {activeIngredient.hasSynonyms && (
                <>
                  ...
                  />
                  <Button appearance="primary" color="blue" onClick={handleAddItem}>
                    Add
                  </Button>
            ...
            <Col xs={24} md={12}>
              <Panel>
                <Accordion bordered>
                  <Accordion.Panel
                    header="Indications"
                    expanded={indicationsCollapsed || !isCollapsed}
                  >
                    <Indications
                      selectedActiveIngredients={selectedactiveIngredient}
                      isEdit={true}
                    />
                  </Accordion.Panel>
