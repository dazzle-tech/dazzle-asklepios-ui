...
const DischargeToWard = ({ operation }) => {
  ...
  useEffect(() => {
    if (wardData?.object) {
      setWard({
        ...wardData.object,
        transferTime: wardData.object.transferTime ? new Date(wardData.object.transferTime) : null
      });
    }
  }, [wardData]);
      ...
      content={
        <>
          ...
          <Row>
            ...
            <Col md={12}>
              <MyInput width="100%" fieldName="finalNotes" record={ward} setRecord={setWard} />
            </Col>
          </Row>
          <MyInput
            width="100%"
