  ...
  const [encounter,setEncounter]=useState({...newApEncounter})
    ...
    const columns = [
        ...
        },
        {
            ...
            render:(rowData:any)=>{
                return rowData?.recoveryLvalue?rowData?.recoveryLvalue.lovDisplayVale:rowData?.recoveryLkey||"";
            }
        },
        {
            key:"actions",
                ...
                return (
                     <HStack spacing={10}>
                        <Whisper
                            placement="top"
                            trigger="hover"
                            speaker={<Tooltip>Recovery</Tooltip>}
                        >
                            <FaSun
                                style={{
                                    fontSize: '1em',
                         ...
                         <Whisper
                            placement="top"
                            trigger="hover"
                            speaker={<Tooltip>Print Report</Tooltip>}
                        >
                            <FaPrint
                                style={{
                                    fontSize: '1em',
