...
import {
  newApMedicationCategories,
  newApMedicationCategoriesClass
...
const MedicationMatrix = () => {
  ...
  const { data: medClassList, refetch: refetchClass } =
    useGetMedicationCategoriesClassQuery(listClassRequest);
  const { data: categoriesList, refetch: refetchCat } =
    useGetMedicationCategoriesQuery(listRequest);
  const { data: classAIList, refetch: refetchClassAI } =
    useGetMedicationCategoriesActiveIngredientQuery(listAIRequest);
