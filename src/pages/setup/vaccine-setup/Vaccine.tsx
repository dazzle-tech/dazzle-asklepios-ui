...
//   const [editBrand, setEditBrand] = useState(false);    baaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaack
  ...
  const [removeVaccineDosesInterval, removeVaccineDosesIntervalMutation] =
    useRemoveVaccineDoseIntervalMutation();
...
//   };
  ...
  //       .then(() => {
  //         refetchVaccineDrand();
  //         if (vaccineBrand.isValid) {
  //           dispatch(notify('Vaccine Brand Deactived Successfully'));
  //         } else {
  //           dispatch(notify('Vaccine Brand Activated Successfully'));
  //         }
  //         refetchVaccineDrand();
  ...
  const { data: vaccineDosesIntervalListResponseLoading, refetch: refetchVaccineDosesInterval } =
  ...
  //   const { data: vaccineBrandsListResponseLoading, refetch: refetchVaccineDrand } =
  //     useGetVaccineBrandsListQuery(vaccineBrandsListRequest);
  const { data: vaccineListResponseLoading, refetch, isFetching } = useGetVaccineListQuery(listRequest);
...
//   }, [selectedValue, vaccine]);
  ...
  return (
    <Panel>
      ...
      {/* <Modal open={popupOpen} onClose={() => handleClear()} size="lg">
        <Modal.Header>
        ...
        <Modal.Body>
          ...
          >
            {' '}
            <div>
              <Button color="blue" onClick={() => handleClear()} appearance="ghost">
                Cancel
              </Button>
            </div>
            <Divider vertical />
                  ...
                  <Col xs={23}>
                    <Grid fluid>
                      <Row gutter={15} style={{ border: '1px solid #e1e1e1' }}>
                        <Col xs={20}></Col>
                        <Col>
                          <ButtonToolbar zoom={0.8} style={{ padding: '6px', display: 'flex' }}>
                            <IconButton
                              size="xs"
                              disabled={
                                vaccineBrand.brandName === '' ||
                                vaccineBrand.manufacturerLkey === undefined ||
                                vaccineBrand.volume === 0 ||
                                vaccineBrand.unitLkey === undefined
                              }
                        ...
                        <Col xs={24}>
                          ...
                          >
                            ...
                            <Table.Column flexGrow={4}>
                              ...
                              <Table.Cell dataKey="marketingAuthorizationHolder"></Table.Cell>
                            </Table.Column>
                            <Table.Column flexGrow={2}>
      ...
      {/**/}
      {/* <Modal open={dossPopupOpen} onClose={() => handleClear()} size="lg">
        <Modal.Header>
          <Modal.Title>New/Edit Vaccine</Modal.Title>
        </Modal.Header>
        <Modal.Body>
                      ...
                      <Row gutter={15} style={{ border: '1px solid #e1e1e1' }}>
                        ...
                        <Col>
                          <ButtonToolbar zoom={0.8} style={{ padding: '6px', display: 'flex' }}>
                            <IconButton
                              disabled={
                                vaccineDose.doseNameLkey === undefined ||
                                vaccineDose.fromAge === 0 ||
                                vaccineDose.fromAgeUnitLkey === undefined
                              }
                              size="xs"
                        ...
                        <Col xs={24}>
                          ...
                          >
                            ...
                            <Table.Column flexGrow={2}>
                              ...
                              <Table.Cell>
                                {rowData => (rowData.fromAge === 0 ? ' ' : rowData.fromAge)}
                              </Table.Cell>
                            </Table.Column>
                            <Table.Column flexGrow={2}>
                            ...
                            <Table.Column flexGrow={2}>
                              ...
                              <Table.Cell>
                                {rowData => (rowData.toAge === 0 ? ' ' : rowData.toAge)}
                              </Table.Cell>
                            </Table.Column>
                            <Table.Column flexGrow={2}>
                            ...
                            <Table.Column flexGrow={2}>
                              ...
                              <Table.Cell>
                                {rowData => (rowData.isBooster ? 'Yes' : 'No')}
                              </Table.Cell>
                            </Table.Column>
                          </Table>
                        </Col>
                            ...
                            <Col>
                              <ButtonToolbar zoom={0.8} style={{ padding: '6px', display: 'flex' }}>
                                <IconButton
                                  size="xs"
                                  disabled={
                                    vaccineDoseInterval.intervalBetweenDoses === 0 ||
                                    vaccineDoseInterval.unitLkey === undefined ||
                                    vaccineDoseInterval.fromDoseKey === undefined ||
                                    vaccineDoseInterval.toDoseKey === undefined
                                  }
                          ...
                          <Row gutter={18}>
                            <Col xs={24}>
                              <Table
                                ...
                                data={
                                  vaccine.key
                                    ? vaccineDosesIntervalListResponseLoading?.object ?? []
                                    : []
                                }
                              >
                                <Table.Column flexGrow={2}>
