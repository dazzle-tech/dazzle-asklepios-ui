...
const AddEditDiagnosticTest = ({ open, setOpen, diagnosticsTest, setDiagnosticsTest, width }) => {
  ...
  const [saveDiagnosticsTestLaboratory] =
    useSaveDiagnosticsTestLaboratoryMutation();
  const [saveDiagnosticsTestRadiology] =
    useSaveDiagnosticsRadiologyTestMutation();
  const [saveDiagnosticsTestPathology] =
    useSaveDiagnosticsTestPathologyMutation();
  ...
  return (
    <MyModal
      ...
      setOpen={setOpen}
      position="right"
      title={diagnosticsTest?.key ? 'Edit Diagnostic Test' : 'New Diagnostic Test'}
      content={conjureFormContentOfMainModal}
      steps={[
        {
          title: 'Basic Info',
          icon: <GrTestDesktop />,
          disabledNext: !diagnosticsTest?.key,
          footer: <MyButton onClick={handleSaveBasicInfo}>Save</MyButton>
        },
        {
          title: 'Details',
          icon: <LuTestTubes />
