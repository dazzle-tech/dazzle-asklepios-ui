...
const Orders = ({ order, setOrder, listOrdersResponse, setListOrdersResponse }) => {
  ...
  const tableColomns = [
    ...
    },
    {
      ...
      fullText: true,
      render: (rowData: any) => {
        return rowData.labStatusLvalue
          ? rowData.labStatusLvalue.lovDisplayVale
          : rowData.labStatusLkey;
      }
    },
    {
      key: '',
      ...
      render: (rowData: any) => {
        return rowData.isUrgent ? (
          <Whisper placement="top" trigger="hover" speaker={<Tooltip>Urgent</Tooltip>}>
