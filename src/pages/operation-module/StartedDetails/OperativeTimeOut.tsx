...
import { Col, Divider, Form, Loader, Row, Text } from "rsuite";
...
const OperativeTimeOut = ({ operation, refetch, editable }) => {
    ...
    const [save, saveMutation] = useSavePreOperativeTimeoutMutation();
    ...
    }, [saveMutation.isLoading, saveMutation.isSuccess, saveMutation.isError]);
