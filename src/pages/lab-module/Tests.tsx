    ...
    const tableClumns = [
      ...
      },
      {
        ...
        render: (rowData: any) => {
          return (
            <>
              {rowData.createdBy && <div>{rowData.createdBy}</div>}
          ...
          return (
            <>
              ...
              <span className="date-table-style">
                {rowData.acceptedAt ? new Date(rowData.acceptedAt).toLocaleString() : ''}
              </span>
            </>
          );
        }
        ...
        render: (rowData: any) => {
          return (
            <>
              ...
              <br />
              <span className="date-table-style">
                {rowData.rejectedAt ? new Date(rowData.rejectedAt).toLocaleString() : ''}
              </span>
            </>
          );
        }
