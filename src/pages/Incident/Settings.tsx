...
const Settings = () => {
  ...
  return (
    <div className="settings-v2 !min-h-screen !bg-[hsl(var(--background))]">
      <div className="!max-w-[80%] !mx-auto !p-6 !space-y-6">
        ...
        {/* General Settings */}
        <Card className="!rounded-[12px] !bg-[var(--card-bg)] !shadow-sm !border ">
            ...
            <div className="!grid !gap-4 md:!grid-cols-2">
              ...
              <div className="!space-y-2">
                ...
                <Input
                  id="adminEmail"
                  type="email"
                  defaultValue="admin@medcare.hospital"
                  className={`${
                    mode === 'light'
                      ? '!min-h-[96px] !text-[14px] !border !border-[#rgb(212 212 212)] !rounded-[8px]'
                      : '!min-h-[96px] !text-[14px] !border !border-[#3a3a3a] !rounded-[8px]'
          ...
          <CardContent className="!p-0">
            ...
            <div className="!flex !items-center !justify-between !px-4 !py-4">
              <div className="!space-y-0.5">
                ...
                <p className="!text-[12px] !text-muted-foreground">
                  Show real-time notifications in dashboard
                </p>
              </div>
              <Switch defaultChecked />
            </div>
          ...
          <CardContent className="!p-0">
            ...
            <div className="!flex !items-center !justify-between !px-4 !py-4">
              <div className="!space-y-0.5">
                ...
                <p className="!text-[12px] !text-muted-foreground">
                  Encrypt all incident data at rest
                </p>
              </div>
        ...
        {/* User Management */}
        <Card className="!rounded-[12px] !border  !bg-[var(--card-bg)] !shadow-sm">
          <CardHeader className="!py-3 !px-4 !border-b ">
            <CardTitle className="!text-[15px] !font-semibold !text-[var(--foreground)] !flex !items-center">
          ...
          <CardContent className="!space-y-4 !p-4">
            ...
            <div className="!flex !items-center !justify-between">
              <div className="!space-y-0.5">
                <Label className="!text-[13px] !text-[var(--foreground)]">
