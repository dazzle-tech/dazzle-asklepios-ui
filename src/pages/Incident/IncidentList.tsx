...
const IncidentList = () => {
  ...
  const filteredIncidents = mockIncidents.filter((incident) => {
    ...
    const matchesStatus =
      statusFilter === "all" ||
      incident.status.toLowerCase().replace(/\s/g, "") === statusFilter;
      ...
      <div className="!max-w-7xl !mx-auto !p-6 !space-y-6">
          ...
          <CardContent className="!pt-0">
            <div className="!grid !gap-4 md:!grid-cols-4">
              ...
              <div className="!space-y-2">
                <label className="!text-[13px] !font-medium !text-[hsl(var(--foreground))]">Search</label>
                <div className="!relative">
                  ...
                  <Input
                    ...
                    className="!pl-10 !h-10 !rounded-md !border !border-[#E6EBF1] focus:!ring-0 focus:!border-[#0B66FF]"
                  />
                </div>
              </div>
              ...
              {/* Status */}
              <div className="!space-y-2">
                <label className="!text-[13px] !font-medium !text-[hsl(var(--foreground))]">Status</label>
                <Select value={statusFilter} onValueChange={setStatusFilter}>
                  <SelectTrigger className="!h-10 !rounded-md !border !border-[#E6EBF1] focus:!ring-0 focus:!border-[#0B66FF]">
              ...
              {/* Severity */}
              <div className="!space-y-2">
                <label className="!text-[13px] !font-medium !text-[hsl(var(--foreground))]">Severity</label>
              ...
              {/* Results */}
              <div className="!space-y-2">
                <label className="!text-[13px] !font-medium !text-[hsl(var(--foreground))]">Results</label>
        ...
        <Card className="!rounded-[12px] !border !border-[#E6EBF1] !shadow-sm">
          <CardContent className="!p-0">
            <Table>
              <TableHeader>
                <TableRow className="!h-12 !border-b !border-[#E6EBF1]">
