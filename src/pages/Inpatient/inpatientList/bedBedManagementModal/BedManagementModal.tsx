...
const BedManagementModal = ({ open, setOpen, departmentKey }) => {
    ...
    const modalContent = (
        <Tabs defaultActiveKey="1" appearance="subtle" className="tab-container">
            <Tabs.Tab eventKey="1" title="Bed Management"  ><BedManagmentFirstTab departmentKey={departmentKey} /></Tabs.Tab>
            <Tabs.Tab eventKey="2" title="Bed Transactions" ><BedTransactionsSecondTab departmentKey={departmentKey} /></Tabs.Tab>
        </Tabs>);
