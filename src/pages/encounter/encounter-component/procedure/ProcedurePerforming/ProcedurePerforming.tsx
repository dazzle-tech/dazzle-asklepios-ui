...
import { Col, Divider, Form, Input, Row, Text } from "rsuite";
import '../styles.less'
const ProcedurePerforming = ({ procedure, setActiveTab, user }) => {
    ...
    const { data: performingList } = useGetProcedurePerformanceQuery(listRequest, { skip: !procedure?.key });
    ...
    return (<>
        <Row gutter={15} className="d">
            <Form fluid >
                ...
                <Col md={12}>
                    <Row> <div className='container-form'>
                        <div className='title-div'>
                            <MyInput
                                width="100%"
                                fieldType="checkbox"
