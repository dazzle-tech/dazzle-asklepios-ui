...
const MedicalHistory = ({ patient, encounter, edit,toShowData }) => {
  return (
    <div className="medical-main-container">
      ...
      <PatientProblems patient={patient} encounter={encounter} edit={edit}  toShowData={toShowData}/>
      <FamilyHistory patient={patient} encounter={encounter} edit={edit}  toShowData={toShowData}/>
      <Hospitalizations patient={patient} encounter={encounter} edit={edit}  toShowData={toShowData}/>
