        ...
        <div className="patient-history-card">
          ...
          <div className="patient-history-content">
            <div className="patient-history-text">
              A 56-year-old male with a history of type 2 diabetes mellitus (diagnosed 2015, managed
              with oral hypoglycemics), hypertension, and hyperlipidemia. Surgical history includes
              coronary artery bypass grafting (2018) and cholecystectomy (2009). He has a documented
              allergy to penicillin (rash) and shellfish (anaphylaxis). Family history is
              significant for ischemic heart disease in his father and type 2 diabetes in his
