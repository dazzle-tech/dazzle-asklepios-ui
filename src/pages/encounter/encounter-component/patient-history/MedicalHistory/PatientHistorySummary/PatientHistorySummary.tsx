            ...
            <div className="patient-history-card">
              ...
              <div className="patient-history-content">
                <div className="patient-history-text">
                  ...
                  managed with oral hypoglycemics), hypertension, and hyperlipidemia. Surgical
                  history includes coronary artery bypass grafting (2018) and cholecystectomy
                  (2009). He has a documented allergy to penicillin (rash) and shellfish
                  (anaphylaxis). Family history is significant for ischemic heart disease in his
                  father and type 2 diabetes in his mother. Social history: non-smoker, occasional
                  alcohol consumption, retired accountant, lives with spouse.
                </div>
              </div>
            </div>
          </div>
