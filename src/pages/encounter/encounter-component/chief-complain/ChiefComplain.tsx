...
const ChiefComplain = ({ patient, encounter, edit }) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      title: 'Region',
      render: (rowData: any) =>
        rowData?.regionLvalue ? rowData.regionLvalue.lovDisplayVale : rowData.regionLkey
    },
    {
      key: 'severityLkey',
      title: 'Severity',
    ...
    <div>
      ...
      <div className="bt-div">
        <MyButton
          ...
          disabled={!edit ? !chiefComplain?.key : true}
        >
      ...
      />
      <CancellationModal
        title="Cancel Chief Complain"
        fieldLabel="Cancellation Reason"
        open={popupCancelOpen}
        setOpen={setPopupCancelOpen}
        object={chiefComplain}
        setObject={setChiefComplain}
