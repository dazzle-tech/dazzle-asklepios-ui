...
const RequestTestModal = ({
  ...
  const [updateRequest, { isLoading: isUpdating }] = useUpdateDiagnosticTestRequestMutation();

  const [deleteRequest, { isLoading: isDeleting }] = useDeleteDiagnosticTestRequestMutation();

  const [createRequest, { isLoading }] = useCreateDiagnosticTestRequestMutation();
  ...
  const handleRowClick = (row: any) => {
    ...
    const selectedType = TypeResponse?.find(t => t.value === row.type)?.value ?? null;
            ...
            <div dir={dir}>
              <Form fluid>
                ...
                <div className="request-test-modal-main-button-container">
                  ...
                  <MyButton onClick={handleSave}>{editMode ? 'Update' : 'Save'}</MyButton>
                </div>
              </Form>
