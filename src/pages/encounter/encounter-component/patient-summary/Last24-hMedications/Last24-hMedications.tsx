...
import { useGetPrescriptionMedicationsQuery, useGetCustomeInstructionsQuery } from '@/services/encounterService';
...
const Last24HMedications = ({ patient, title = null }) => {
    ...
    const { data: genericMedicationActiveIngredientListResponseData } = useGetGenericMedicationActiveIngredientQuery({ ...listGinricRequest });
            ...
            <div className='medical-dashboard-container-div'>
                <div className='medical-dashboard-header-div'>
                    <div className='medical-dashboard-title-div'>
                        {title ? title : "Last 24-h Medications"}
                    </div>
...
export default Last24HMedications;