...
const AudiometryPuretone = () => {
  ...
  const {
    data: audiometryPuretonResponse,
    refetch: refetchAudiometryPureton,
    isLoading
  } = useGetAudiometryPuretonesQuery(audiometryPuretoneListRequest);
  ...
  return (
    <div>
          ...
          <div className="bt-div-2">
            <div className="bt-left-2">
              <MyButton
                ...
                disabled={!edit ? !audiometryPuretone?.key : true}
              >
            ...
            <div className="bt-right-2">
              <MyButton
                disabled={edit}
                prefixIcon={() => <PlusIcon />}
                onClick={handleAddNewAudiometryPuretone}
              >
                Add
              </MyButton>
            </div>
      ...
      />
      <CancellationModal
        title="Cancel Audiometry Puretone"
        fieldLabel="Cancellation Reason"
        open={popupCancelOpen}
        setOpen={setPopupCancelOpen}
        object={audiometryPuretone}
        setObject={setAudiometryPuretone}
        handleCancle={handleCancle}
        fieldName="cancellationReason"
      />
      <AddAudiometryPuretone
        open={open}
        setOpen={setOpen}
        patient={patient}
        encounter={encounter}
        audiometryPuretoneObject={audiometryPuretone}
        refetch={refetchAudiometryPureton}
        edit={edit}
      />
    </div>
