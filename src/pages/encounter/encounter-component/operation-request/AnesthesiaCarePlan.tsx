...
import { useSaveOperationCarePlanMutation, useSaveOperationRequestsMutation } from "@/services/operationService";
...
const AnesthesiaCarePlan = ({ operation, patient, encounter, user }) => {
    ...
    const handelSave = async () => {
        try {
            await save({
                ...carePlan, createdBy: user.key,
                patientKey: patient.key, encounterKey: encounter.key,
    ...
    return (<Form fluid >
        <Row gutter={15}>
            ...
            <Row>
                ...
                <Col md={24}> <div className='container-form'>
                    <div className='title-div'>
        ...
        <div className='bt-div'>
            <div className="bt-right">
                ...
                <MyButton onClick={()=>setOpenDrugOrder(true)}>Pre-medication</MyButton>
        ...
        <MyModal
            ...
            content={
                <DrugOrder patient={patient} encounter={encounter} edit={false} />
            }
        ...
        title="Test Result"
        content={<DiagnosticsResult ></DiagnosticsResult>}
