...
const AddChiefComplaintSymptoms = ({
  open,
  setOpen,
  patient,
  encounter,
  ...
  const [isEncounterChiefComplaintSymptomsStatusClose, setIsChiefComplaintSymptomsStatusClose] =
    useState(false);
    ...
    try {
      if (complaintSymptoms.key === undefined) {
        await saveComplaintSymptoms({
          ...
          onsetDate: complaintSymptoms?.onsetDate
            ? new Date(complaintSymptoms.onsetDate).getTime()
            : 0,
          ...
          content={
            <Form className="flex-row-3">
              ...
              <MyInput
                ...
                disabled={isDisabledField}
              />
              <Form className="Associated-Symptoms-Container">
                <MyInput
                  width={200}
