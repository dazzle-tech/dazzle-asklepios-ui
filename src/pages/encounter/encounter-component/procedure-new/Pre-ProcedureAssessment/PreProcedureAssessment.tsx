      ...
      <Row gutter={15} className="d">
        <Form fluid>
          <Col md={12}>
            ...
            <Row>
              <SectionContainer
                title={<Text>Pre-Procedure Checklist</Text>}
                content={
                  <>
                    <Row>
                      <Col md={8}>
          ...
          <Col md={12}>
            <Row>
              <SectionContainer
                title={<Text>Pre-Procedure Vitals</Text>}
                content={
            ...
            <Row>
              <SectionContainer
                title={<Text>Pre Anesthesia</Text>}
                content={
                  <Row>
                    <Col md={12}>
                      <MyInput
            ...
            <Row>
              <SectionContainer
                title={<Text>Lab and Imaging Results</Text>}
                content={
