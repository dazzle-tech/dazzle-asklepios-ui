...
import { ApOptometricExam } from '@/types/model-types';
...
const OptometricExam = ({ patient, encounter }) => {
  ...
  //LOV
  const { data: medicalHistoryLovQueryResponse } =
    useGetLovValuesByCodeQuery('EYE_MEDICAL_HISTORY');
  const { data: performedWithLovQueryResponse } = useGetLovValuesByCodeQuery('EYE_VISUAL_ACUITY');
  const { data: improvmentsStatusLovQueryResponse } =
    useGetLovValuesByCodeQuery('IMPROVEMENTS_STATUS');
  ...
  const { data: optometricExamResponse, refetch: refetchOptometricExam } =
    useGetOptometricExamsQuery(optometricExamListRequest);
  ...
  return (
    <Panel header={'Optometric Exam'}>
      ...
      <Panel header={'Interpretation & Diagnosis'} collapsible bordered>
        <Form fluid layout="inline" style={{ display: 'flex', alignItems: 'center', gap: '7px' }}>
          <div>
            <InputGroup inside style={{ width: '210px', marginTop: '20px' }}>
          ...
          <div>
            <Text>Vision Diagnosis</Text>
            <InputGroup>
              <Input disabled={true} style={{ width: '300px' }} value={selectedicd10} />
            </InputGroup>
          </div>
          <div>
            <InputGroup inside style={{ width: '210px', marginTop: '20px' }}>
          ...
          <div>
            <Text>Vision Diagnosis</Text>
            <InputGroup>
              <Input disabled={true} style={{ width: '300px' }} value={secondSelectedicd10} />
            </InputGroup>
          </div>
          <MyInput
            width={165}
      ...
      <Panel>
        ...
        >
          ...
          <Column width={150}>
            ...
            <Cell>
              {rowData =>
                rowData?.pinholeTestResultLvalue
          ...
          <Column width={150}>
            ...
            <Cell>{rowData => rowData?.numberOfPlatesTested}</Cell>
          </Column>
          <Column width={150}>
            <HeaderCell>Correct Answers Count</HeaderCell>
            <Cell>{rowData => rowData?.correctAnswersCount}</Cell>
          </Column>
          <Column width={150}>
            <HeaderCell>Deficiency Type</HeaderCell>
            <Cell>
              {rowData =>
                rowData?.deficiencyTypeLvalue
          ...
          <Column width={150}>
            <HeaderCell>Right Eye</HeaderCell>
            <Cell>{rowData => rowData?.rightEye}</Cell>
          </Column>
          <Column width={150}>
            <HeaderCell>Left Eye</HeaderCell>
            <Cell>{rowData => rowData?.leftEye}</Cell>
          </Column>
          <Column width={150}>
            <HeaderCell>Right Eye</HeaderCell>
            <Cell>{rowData => rowData?.rightEye}</Cell>
          ...
          <Column width={150}>
            ...
            <Cell>{rowData => rowData?.measurementMethod}</Cell>
          </Column>
          <Column width={150}>
      ...
      <Modal open={popupCancelOpen} onClose={() => setPopupCancelOpen(false)} size="sm">
        <Modal.Header>
          <Translate>
        ...
        <Modal.Footer>
          ...
          <Button
            ...
            style={{ color: 'var(--primary-blue)', backgroundColor: 'white' }}
          >
            Close
          </Button>
        </Modal.Footer>
