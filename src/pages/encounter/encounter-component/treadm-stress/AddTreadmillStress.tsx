...
const AddTreadmillStress = ({
  ...
  const [isEncounterTreadmillStressStatusClose, setIsEncounterTreadmillStressStatusClose] =
    useState(false);
  const [isEncounterStatusClosed, setIsEncounterStatusClosed] = useState(false);
  const dispatch = useAppDispatch();

  // Fetch LOV data for various fields
  const { data: baselineECGFindingsLovQueryResponse } =
    useGetLovValuesByCodeQuery('CARDIAC_ECG_FINDINGS');
