    ...
    <Form disabled layout="inline" fluid>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <Input
            disabled
            value={(bodyMeasurements.weight / (bodyMeasurements.height / 100) ** 2).toFixed(2)}
            style={{ width: 150 }}
          />
        </div>
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <Input
            disabled
            value={Math.sqrt((bodyMeasurements.weight * bodyMeasurements.height) / 3600).toFixed(2)}
            style={{ width: 150 }}
          />
        </div>
        <MyInput
          ...
          record={patirntObservationlist?.object[0]}
        />
      </div>
      <br />
      <MyInput
