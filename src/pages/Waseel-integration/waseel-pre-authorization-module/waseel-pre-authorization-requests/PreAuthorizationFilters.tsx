...
type PreAuthorizationFiltersProps = {
  filtersKey: number;
  filters: Filters;
...
const PreAuthorizationFilters: React.FC<PreAuthorizationFiltersProps> = ({
  filtersKey,
  filters,
  selectedFilter,
  onFiltersChange,
  ...
  return (
    <Form fluid className="pre-auth-filters-form" key={filtersKey}>
...
export default PreAuthorizationFilters;
