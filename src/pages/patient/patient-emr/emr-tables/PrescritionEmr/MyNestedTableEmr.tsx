...
import '@/components/MyNestedTable/styles.less';
...
interface MyNestedTableProps {
  ...
  onExpandRow?: (rowData: any, opening: boolean) => void;
...
const MyNestedTableEmr: React.FC<MyNestedTableProps> = ({
  data,
  columns,
  height = '50vh',
  nestedHeight = '22vh',
  ...
  const handleExpandClick = (index: number, row: any) => {
    const opening = expandedRow !== index;
    setExpandedRow(opening ? index : null);
    onExpandRow?.(row, opening);
  };
...
export default MyNestedTableEmr;
