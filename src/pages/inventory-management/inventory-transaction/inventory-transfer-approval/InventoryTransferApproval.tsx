...
const inventoryTransferApproval = () => {
  ...
  const { data: transstatusListResponse, refetch: refetchTransStatus } =
    useGetLovValuesByCodeQuery('LABRAD_ORDER_STATUS');
  ...
  const { data: inventoryTransListResponse, refetch: refetchTransProduct } =
    useGetInventoryTransferQuery(transactionProductListRequest);
